...
import ai.must-b.app.ui.mobileSurface
import ai.must-b.app.ui.mobileText
import ai.must-b.app.ui.mobileTextSecondary
import ai.must-b.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.must-b.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.must-b.app.ui.mobileFontFamily,
