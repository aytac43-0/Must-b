...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.must-b.ios", category: "LiveActivity")
    private var currentActivity: Activity<Must-bActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = Must-bActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<Must-bActivityAttributes>.activities
    ...
    private func updateCurrent(state: Must-bActivityAttributes.ContentState) {
    ...
    private func connectingState() -> Must-bActivityAttributes.ContentState {
        Must-bActivityAttributes.ContentState(
    ...
    private func idleState() -> Must-bActivityAttributes.ContentState {
        Must-bActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> Must-bActivityAttributes.ContentState {
        Must-bActivityAttributes.ContentState(
