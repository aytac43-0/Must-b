...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<MustBActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = MustBActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<MustBActivityAttributes>.activities
    ...
    private func updateCurrent(state: MustBActivityAttributes.ContentState) {
    ...
    private func connectingState() -> MustBActivityAttributes.ContentState {
        MustBActivityAttributes.ContentState(
    ...
    private func idleState() -> MustBActivityAttributes.ContentState {
        MustBActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> MustBActivityAttributes.ContentState {
        MustBActivityAttributes.ContentState(
