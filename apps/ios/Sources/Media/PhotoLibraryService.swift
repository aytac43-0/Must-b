...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: Must-bPhotosLatestParams) async throws -> Must-bPhotosLatestPayload {
        ...
        var results: [Must-bPhotoPayload] = []
        ...
        return Must-bPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> Must-bPhotoPayload
    {
