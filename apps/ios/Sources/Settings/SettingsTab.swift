...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = MustBLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = MustBLocationMode.off.rawValue
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(MustBLocationMode.off.rawValue)
                            Text("While Using").tag(MustBLocationMode.whileUsing.rawValue)
                            Text("Always").tag(MustBLocationMode.always.rawValue)
                        }
                        .labelsHidden()
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = MustBLocationMode(rawValue: newValue) else { return }
                Task {
