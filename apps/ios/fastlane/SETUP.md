...
ASC_KEYCHAIN_SERVICE=must-b-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.must-b.client
# or
...
- The beta flow regenerates `apps/ios/Must-b.xcodeproj` from `apps/ios/project.yml` before archiving
