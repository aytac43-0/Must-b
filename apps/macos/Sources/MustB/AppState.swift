...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MustBConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MustBConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: MustBConfigFile.loadDict(),
        ...
        MustBConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/must-b"
        state.remoteCliPath = ""
        return state
    }
}
