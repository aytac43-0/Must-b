...
enum CommandResolver {
    ...
    static func projectMustBExecutable(projectRoot: URL? = nil) -> String? {
        #if DEBUG
    ...
    static func hasAnyMustBInvoker(searchPaths: [String]? = nil) -> Bool {
        ...
        searchPaths: [String]? = nil) -> [String]
    {
        ...
        let root = self.projectRoot()
        if let must-bPath = self.projectMustBExecutable(projectRoot: root) {
    ...
    {
        let root = configRoot ?? MustBConfigFile.loadDict()
