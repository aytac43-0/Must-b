...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.must-b", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        Must-bPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        Must-bPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
