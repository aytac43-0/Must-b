...
/// Menu contents for the Must-b menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Must-b") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Must-b Not Configured"
        case .remote:
            "Remote Must-b Active"
        case .local:
            "Must-b Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .must-bSelectSettingsTab, object: tab)
        }
    }
