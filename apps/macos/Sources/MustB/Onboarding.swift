...
enum UIStrings {
    static let welcomeTitle = "Welcome to Must-b"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "must-b.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: Must-bChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g must-b@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: Must-bChatViewModel(
