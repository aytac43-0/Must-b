...
private let onboardingWizardLogger = Logger(subsystem: "ai.must-b", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between MustBProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = MustBProtocol.AnyCodable
