...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: MustBPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = MustBPeekabooBridgeServices()
...
@MainActor
private final class MustBPeekabooBridgeServices: PeekabooBridgeServiceProviding {
