...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = MustBLocationMode.off.rawValue
    ...
    private var locationMode: MustBLocationMode {
        MustBLocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: MustBLocationMode) async -> Bool {
