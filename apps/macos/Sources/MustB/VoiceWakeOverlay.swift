...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.must-b", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Must-b windows, but below the system’s pop-up menus.
