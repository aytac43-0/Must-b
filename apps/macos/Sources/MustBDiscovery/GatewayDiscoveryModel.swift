...
public final class GatewayDiscoveryModel {
    ...
    public func start() {
        ...
        for domain in MustBBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                serviceType: MustBBonjour.gatewayServiceType,
                domain: domain,
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = MustBBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = MustBBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = MustBBonjour.wideAreaGatewayServiceDomain else { return false }
