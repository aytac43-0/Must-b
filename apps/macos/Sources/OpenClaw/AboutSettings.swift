...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/must-b/must-b") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/must-b/must-b")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://must-b.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "Must-bBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Must-bBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "Must-bGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Must-bGitCommit") as? String) ??
            "unknown"
    }
