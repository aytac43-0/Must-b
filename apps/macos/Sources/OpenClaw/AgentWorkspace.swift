...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.must-b", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return Must-bConfigFile.defaultWorkspaceURL() }
