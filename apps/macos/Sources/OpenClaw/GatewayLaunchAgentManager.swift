...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.must-b", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".must-b/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.must-bCommand(
            subcommand: "gateway",
