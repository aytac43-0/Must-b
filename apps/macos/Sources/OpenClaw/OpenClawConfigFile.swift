...
enum Must-bConfigFile {
    private static let logger = Logger(subsystem: "ai.must-b", category: "config")
    ...
    static func stateDirURL() -> URL {
        Must-bPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        Must-bPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-must-b-config-file",
            "event": "config.write",
