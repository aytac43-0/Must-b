...
public typealias Must-bPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias Must-bPlatformImage = UIImage
#endif

public struct Must-bChatUsageCost: Codable, Hashable, Sendable {
...
public struct Must-bChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: Must-bChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(Must-bChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct Must-bChatMessageContent: Codable, Hashable, Sendable {
...
public struct Must-bChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [Must-bChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: Must-bChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [Must-bChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: Must-bChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(Must-bChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([Must-bChatMessageContent].self, forKey: .content) {
...
public struct Must-bChatHistoryPayload: Codable, Sendable {
...
public struct Must-bSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct Must-bSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [Must-bSessionPreviewItem]
}

public struct Must-bSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [Must-bSessionPreviewEntry]

    public init(ts: Int, previews: [Must-bSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct Must-bChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct Must-bChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct Must-bAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct Must-bChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct Must-bGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct Must-bPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: Must-bPlatformImage?
...
public struct Must-bChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
