...
public typealias MustBPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MustBPlatformImage = UIImage
#endif

public struct MustBChatUsageCost: Codable, Hashable, Sendable {
...
public struct MustBChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MustBChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MustBChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MustBChatMessageContent: Codable, Hashable, Sendable {
...
public struct MustBChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MustBChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MustBChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MustBChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MustBChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MustBChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MustBChatMessageContent].self, forKey: .content) {
...
public struct MustBChatHistoryPayload: Codable, Sendable {
...
public struct MustBSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MustBSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MustBSessionPreviewItem]
}

public struct MustBSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MustBSessionPreviewEntry]

    public init(ts: Int, previews: [MustBSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MustBChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MustBChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MustBAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MustBChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MustBGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MustBPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MustBPlatformImage?
...
public struct MustBChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
