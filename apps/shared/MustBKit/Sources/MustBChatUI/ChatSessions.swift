...
public struct MustBChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct MustBChatSessionsDefaults: Codable, Sendable {
...
public struct MustBChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct MustBChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: MustBChatSessionsDefaults?
    public let sessions: [MustBChatSessionEntry]
    ...
    public init(
        ...
        sessions: [MustBChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
