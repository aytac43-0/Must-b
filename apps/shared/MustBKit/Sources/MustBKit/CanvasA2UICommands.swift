...
public enum MustBCanvasA2UICommand: String, Codable, Sendable {
...
public struct MustBCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MustBCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
