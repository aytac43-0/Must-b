...
public enum Must-bCanvasA2UICommand: String, Codable, Sendable {
...
public struct Must-bCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct Must-bCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
