...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: MustBProtocol.AnyCodable]?
    {
        ...
        return [
            "id": MustBProtocol.AnyCodable(identity.deviceId),
            "publicKey": MustBProtocol.AnyCodable(publicKey),
            "signature": MustBProtocol.AnyCodable(signature),
            "signedAt": MustBProtocol.AnyCodable(signedAtMs),
            "nonce": MustBProtocol.AnyCodable(nonce),
        ]
    }
}
