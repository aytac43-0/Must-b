...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: Must-bProtocol.AnyCodable]?
    {
        ...
        return [
            "id": Must-bProtocol.AnyCodable(identity.deviceId),
            "publicKey": Must-bProtocol.AnyCodable(publicKey),
            "signature": Must-bProtocol.AnyCodable(signature),
            "signedAt": Must-bProtocol.AnyCodable(signedAtMs),
            "nonce": Must-bProtocol.AnyCodable(nonce),
        ]
    }
}
