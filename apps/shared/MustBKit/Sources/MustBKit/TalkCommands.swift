...
public enum MustBTalkCommand: String, Codable, Sendable {
...
public struct MustBTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MustBTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
