...
public enum Must-bTalkCommand: String, Codable, Sendable {
...
public struct Must-bTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct Must-bTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
