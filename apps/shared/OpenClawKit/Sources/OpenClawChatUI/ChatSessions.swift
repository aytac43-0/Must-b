...
public struct Must-bChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct Must-bChatSessionsDefaults: Codable, Sendable {
...
public struct Must-bChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct Must-bChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: Must-bChatSessionsDefaults?
    public let sessions: [Must-bChatSessionEntry]
    ...
    public init(
        ...
        sessions: [Must-bChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
