...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.must-b", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.must-b", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: Must-bProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
