# Contributing to Must-b

Welcome to the lobster tank! 

## Quick Links

- **GitHub:** https://github.com/must-b/must-b
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@must-b](https://x.com/must-b)

## Maintainers

- **Mustafa Aytaç ÖZTAN** - Benevolent Dictator
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/must-b/must-b/discussions) or ask in Discord first
...
- Test locally with your Must-b instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Must-b skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/must-b/must-b/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape Must-b's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@must-b.ai with:

- Links to your PRs on Must-b (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@must-b.ai** and we'll route it.
