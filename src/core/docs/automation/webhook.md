...
read_when:
  ...
  - Wiring external systems into Must-b
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Must-b config directory (typically `~/.must-b/hooks/transforms`).
...
- `must-b webhooks gmail setup` writes `hooks.gmail` config for `must-b webhooks gmail run`.
