...
Must-b treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Must-b “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Must-b can see that group and respond there.
...
Translation: allowlisted senders can trigger Must-b by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@must-b", "must-b", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
