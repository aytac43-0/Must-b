...
read_when:
  ...
  - Reviewing Must-b security posture
title: "Pairing"
---

# Pairing

“Pairing” is Must-b’s explicit **owner approval** step.
...
Stored under `~/.must-b/credentials/`:
...
3. On your phone, open the Must-b iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `must-b nodes pending/approve`) is a
