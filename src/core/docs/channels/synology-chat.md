---
summary: "Synology Chat webhook setup and Must-b config"
read_when:
  - Setting up Synology Chat with Must-b
...
```bash
must-b plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Must-b gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Must-b.
...
- Pairing approvals work with:
  - `must-b pairing list synology-chat`
  - `must-b pairing approve synology-chat <CODE>`
...
```bash
must-b message send --channel synology-chat --target 123456 --text "Hello from Must-b"
must-b message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
