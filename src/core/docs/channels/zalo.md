...
- Install via CLI: `must-b plugins install @must-b/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `must-b plugins install ./extensions/zalo`
   - From npm (if published): `must-b plugins install @must-b/zalo`
...
- Approve via:
  - `must-b pairing list zalo`
  - `must-b pairing approve zalo <CODE>`
...
- Example: `must-b message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `must-b channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `must-b logs --follow`
