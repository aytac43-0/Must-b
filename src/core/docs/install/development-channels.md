...
Must-b ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Must-b also aligns
the install method:
...
When you switch channels with `must-b update`, Must-b also syncs plugin sources:
