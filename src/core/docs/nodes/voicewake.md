...
Must-b treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.must-b/settings/voicewake.json`

Shape:

```json
{ "triggers": ["must-b", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
