...
read_when:
  - You want to publish a third-party Must-b plugin
...
This page tracks high-quality **community-maintained plugins** for Must-b.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `must-b plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `must-b plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Must-b to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/must-b-wechat`
  repo: `https://github.com/icesword0760/must-b-wechat`
  install: `must-b plugins install @icesword760/must-b-wechat`
