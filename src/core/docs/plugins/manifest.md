...
read_when:
  - You are building a Must-b plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (must-b.plugin.json)

Every plugin **must** ship a `must-b.plugin.json` file in the **plugin root**.
Must-b uses this manifest to validate configuration **without executing plugin
