...
You can point Must-b at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Must-b
...
- [Anthropic provider](/providers/anthropic) - Native Must-b integration with Claude setup-token or API keys
