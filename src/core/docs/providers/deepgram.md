...
Deepgram is a speech-to-text API. In Must-b it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Must-b uploads the audio file to Deepgram and injects the transcript
