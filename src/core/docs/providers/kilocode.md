---
summary: "Use Kilo Gateway's unified API to access many models in Must-b"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Must-b
---
...
```bash
must-b onboard --kilocode-api-key <key>
```
...
Must-b dynamically discovers available models from the Kilo Gateway at startup. Use
