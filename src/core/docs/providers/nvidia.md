---
summary: "Use NVIDIA's OpenAI-compatible API in Must-b"
read_when:
  - You want to use NVIDIA models in Must-b
...
must-b onboard --auth-choice skip
must-b models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
