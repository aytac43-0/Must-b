---
summary: "Use Qianfan's unified API to access many models in Must-b"
read_when:
...
3. Must-b installed on your system
...
4. Copy the API key for use with Must-b

## CLI setup

```bash
must-b onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Must-b Configuration](/gateway/configuration)
