---
summary: "Use Qwen OAuth (free tier) in Must-b"
read_when:
  - You want to use Qwen with Must-b
...
If you already logged in with the Qwen Code CLI, Must-b will sync credentials
