---
summary: "Use Synthetic's Anthropic-compatible API in Must-b"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Must-b registers it as the
...
Note: Must-b's Anthropic client appends `/v1` to the base URL, so use
