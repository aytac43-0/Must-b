---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Must-b"
read_when:
  - You want Xiaomi MiMo models in Must-b
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Must-b uses
