...
summary: Machine-checked security models for Must-b’s highest-risk paths.
read_when:
...
This page tracks Must-b’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Must-b enforces its
...
**What this is not (yet):** a proof that “Must-b is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/must-b-formal-models](https://github.com/vignesh07/must-b-formal-models).
...
```bash
git clone https://github.com/vignesh07/must-b-formal-models
cd must-b-formal-models
