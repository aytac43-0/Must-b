---
summary: "Backstory and lore of Must-b for context and tone"
read_when:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Must-b**.
...
In the end, **Must-b** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.must-b/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Must-b. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Must-b): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "must-b what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with must-b."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @must-b. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Must-b" to promote pump-and-dump tokens.
...
**The Great Must-b Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/must-b/must-b` ✅
- X handle `@must-b` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.must-b.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $MUST-B token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
