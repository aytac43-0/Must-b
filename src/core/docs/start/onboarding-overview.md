---
summary: "Overview of Must-b onboarding options and flows"
read_when:
...
Must-b supports multiple onboarding paths depending on where the Gateway runs
...
- [`must-b onboard` command](/cli/onboard)

## macOS app onboarding

Use the Must-b app when you want a fully guided setup on macOS. Docs:
