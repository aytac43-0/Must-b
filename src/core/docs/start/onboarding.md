---
summary: "First-run onboarding flow for Must-b (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Must-b">
...
<Step title="CLI">
  ...
  The app can install the global `must-b` CLI via npm/pnpm so terminal
