...
This directory contains the **BlueBubbles external channel plugin** for Must-b.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `must-b/plugin-sdk` helpers.
