...
import { resolveChannelMediaMaxBytes, type MustBConfig } from "must-b/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: MustBConfig; accountId?: string }): string[] {
