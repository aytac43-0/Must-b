...
import { resolveChannelMediaMaxBytes, type Must-bConfig } from "must-b/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: Must-bConfig; accountId?: string }): string[] {
