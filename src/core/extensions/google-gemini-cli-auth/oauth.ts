...
import { fetchWithSsrFGuard, isWSL2Sync } from "must-b/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["MUSTB_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Must-b.</p></body></html>",
        );
