...
import { createAccountListHelpers, type MustBConfig } from "must-b/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: MustBConfig): ResolvedGoogleChatAccount[] {
