import type { MustBConfig, PluginRuntime, ResolvedLineAccount } from "must-b/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: MustBConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: MustBConfig; accountId: string }): Promise<{
