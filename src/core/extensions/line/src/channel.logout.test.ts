import type { Must-bConfig, PluginRuntime, ResolvedLineAccount } from "must-b/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: Must-bConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: Must-bConfig; accountId: string }): Promise<{
