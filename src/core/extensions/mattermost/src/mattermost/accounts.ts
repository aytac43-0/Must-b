...
import { createAccountListHelpers, type Must-bConfig } from "must-b/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: Must-bConfig): ResolvedMattermostAccount[] {
