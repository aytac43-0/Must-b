...
import { createAccountListHelpers, type MustBConfig } from "must-b/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: MustBConfig): ResolvedMattermostAccount[] {
