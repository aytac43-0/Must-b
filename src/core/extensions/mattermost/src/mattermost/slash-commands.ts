...
/**
 * Built-in Must-b commands to register as native slash commands.
...
/**
 * Register all Must-b slash commands for a given team.
...
/**
 * Map the trigger word back to the original Must-b command name.
