...
Nostr DM channel plugin for Must-b using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Must-b. It enables your bot to:
...
# Configure must-b to use local relay
