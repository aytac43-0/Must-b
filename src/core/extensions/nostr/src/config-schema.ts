import { AllowFromListSchema, DmPolicySchema } from "must-b/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "must-b/plugin-sdk/nostr";
import { z } from "zod";
