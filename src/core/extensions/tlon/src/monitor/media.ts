...
import { fetchWithSsrFGuard } from "must-b/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Must-b workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".must-b", "workspace", "media", "inbound");
 ...
 * Format matches Must-b's expected attachment structure.
 */
