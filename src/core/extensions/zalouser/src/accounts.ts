...
import { createAccountListHelpers, type Must-bConfig } from "must-b/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: Must-bConfig, accountId: string): ZalouserAccountConfig {
