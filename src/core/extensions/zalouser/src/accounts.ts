...
import { createAccountListHelpers, type MustBConfig } from "must-b/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: MustBConfig, accountId: string): ZalouserAccountConfig {
