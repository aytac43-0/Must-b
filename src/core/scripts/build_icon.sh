...
# Defaults target the Must-b assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Must-b/Resources/Must-b.icns"}
