...
- MUSTB_GATEWAY_VERSION = exact package.json version
- MUSTB_MARKETING_VERSION = short iOS/App Store version
- MUSTB_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
MUSTB_GATEWAY_VERSION = ${PACKAGE_VERSION}
MUSTB_MARKETING_VERSION = ${MARKETING_VERSION}
MUSTB_BUILD_VERSION = ${BUILD_NUMBER}
EOF
