...
# Output:
# - dist/Must-b.app
# - dist/Must-b-<version>.zip
# - dist/Must-b-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.must-b.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Must-b.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Must-b-$VERSION.zip"
DMG="$ROOT_DIR/dist/Must-b-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Must-b-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Must-b-$VERSION.dSYM.zip"
