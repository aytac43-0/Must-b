...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.must-b/must-b.json`
...
- The script prints a `MEDIA:` line for Must-b to auto-attach on supported chat providers.
