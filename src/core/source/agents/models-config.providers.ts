...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Must-b docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Must-b keeps auth in auth-profiles and resolves runtime availability from that store.
