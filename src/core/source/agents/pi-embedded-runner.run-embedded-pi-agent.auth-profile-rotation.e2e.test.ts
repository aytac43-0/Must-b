...
const makeConfig = (opts?: { fallbacks?: string[]; apiKey?: string }): MustBonfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeAgentOverrideOnlyFallbackConfig = (agentId: string): MustBonfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeCopilotConfig = (): MustBonfig =>
  ({
    models: {
      providers: {
        "github-copilot": {
