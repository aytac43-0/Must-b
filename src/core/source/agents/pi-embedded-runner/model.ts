 ...
 * a hint.
 *
 * See: https://github.com/must-b/must-b/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "must-b configure". ' +
    "See: https://docs.must-b.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "must-b configure". ' +
    "See: https://docs.must-b.ai/providers/vllm",
};
