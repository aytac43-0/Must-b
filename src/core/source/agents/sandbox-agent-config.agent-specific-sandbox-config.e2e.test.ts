...
async function resolveContext(config: Must-bConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): Must-bConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
