...
async function resolveContext(config: MustBonfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): MustBonfig {
  return {
    agents: {
      defaults: {
        sandbox: {
