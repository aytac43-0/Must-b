...
export const DEFAULT_SANDBOX_IMAGE = "must-b-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "must-b-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "must-b-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "must-b-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "must-b-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "must-b-sandbox-browser";
