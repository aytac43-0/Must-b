...
const CLEANUP_STATE_KEY = Symbol.for("must-b.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("must-b.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("must-b.sessionWriteLockWatchdogState");
