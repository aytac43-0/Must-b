...
function resolveWatchPaths(workspaceDir: string, config?: Must-bConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: Must-bConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: Must-bConfig }) {
