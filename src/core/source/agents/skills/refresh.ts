...
function resolveWatchPaths(workspaceDir: string, config?: MustBonfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MustBonfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MustBonfig }) {
