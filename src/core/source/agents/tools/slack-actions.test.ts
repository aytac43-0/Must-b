...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): MustBonfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: MustBonfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: MustBonfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
