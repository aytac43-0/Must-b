...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@must-b", { botUsername: "must-b" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@must-b args", {
        botUsername: "must-b",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "must-b" })).toBe(
      "/help@otherbot",
    );
  });
