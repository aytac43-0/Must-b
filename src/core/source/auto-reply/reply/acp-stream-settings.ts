...
function resolveAcpStreamCoalesceIdleMs(cfg: Must-bConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: Must-bConfig): number {
...
export function resolveAcpProjectionSettings(cfg: Must-bConfig): AcpProjectionSettings {
