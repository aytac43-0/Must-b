...
function resolveAcpStreamCoalesceIdleMs(cfg: MustBonfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: MustBonfig): number {
...
export function resolveAcpProjectionSettings(cfg: MustBonfig): AcpProjectionSettings {
