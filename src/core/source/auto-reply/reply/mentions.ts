...
function resolveMentionPatterns(cfg: Must-bConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: Must-bConfig | undefined, agentId?: string): RegExp[] {
