...
export const A2UI_PATH = "/__must-b__/a2ui";

export const CANVAS_HOST_PATH = "/__must-b__/canvas";

export const CANVAS_WS_PATH = "/__must-b__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.must-bCanvasA2UIAction.postMessage(...)
  // - Android: window.must-bCanvasA2UIAction.postMessage(...)
  const handlerNames = ["must-bCanvasA2UIAction"];
  ...
  globalThis.Must-b = globalThis.Must-b ?? {};
  globalThis.Must-b.postMessage = postToNode;
  globalThis.Must-b.sendUserAction = sendUserAction;
  globalThis.must-bPostMessage = postToNode;
  globalThis.must-bSendUserAction = sendUserAction;
