...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: Must-bConfig): string | undefined {
  ...
  function listAccountIds(cfg: Must-bConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: Must-bConfig): string {
