...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: MustBonfig): string | undefined {
  ...
  function listAccountIds(cfg: MustBonfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: MustBonfig): string {
