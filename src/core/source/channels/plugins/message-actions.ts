...
export function listChannelMessageActions(cfg: Must-bConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: Must-bConfig): boolean {
...
export function supportsChannelMessageCards(cfg: Must-bConfig): boolean {
