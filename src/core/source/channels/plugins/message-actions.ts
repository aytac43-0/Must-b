...
export function listChannelMessageActions(cfg: MustBonfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MustBonfig): boolean {
...
export function supportsChannelMessageCards(cfg: MustBonfig): boolean {
