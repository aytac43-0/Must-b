    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["must-b directory self --channel slack", "Show the connected account identity."],
          [
            'must-b directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["must-b directory groups list --channel discord", "List available groups/channels."],
          [
            "must-b directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.must-b.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
