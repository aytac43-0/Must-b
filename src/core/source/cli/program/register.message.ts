...
${formatHelpExamples([
  ['must-b message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'must-b message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'must-b message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.must-b.ai/cli/message")}`,
    )
    .action(() => {
