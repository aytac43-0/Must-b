...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.MUSTB_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.MUSTB_DISABLE_LAZY_SUBCOMMANDS);
};
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live Must-b docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage Must-b plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
