const DEFAULT_TAGLINE = "All your chats, one Must-b.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a red panda on caffeine: quick, precise, effective.",
  ...
  "Built by Auto Step, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'must-b gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.MUSTB_TAGLINE_INDEX;
