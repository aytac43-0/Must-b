...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set MUSTB_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `must-b dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Must-b.");
  } else if (hint) {
    runtime.log(hint);
  }
}
