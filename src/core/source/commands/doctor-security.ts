...
import type { MustBonfig, GatewayBindMode } from "../config/config.js";
...
function collectImplicitHeartbeatDirectPolicyWarnings(cfg: MustBonfig): string[] {
...
export async function noteSecurityWarnings(cfg: MustBonfig) {
  const warnings: string[] = [];
