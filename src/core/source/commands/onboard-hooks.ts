...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.must-b.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("must-b hooks list")}`,
      `  ${formatCliCommand("must-b hooks enable <name>")}`,
      `  ${formatCliCommand("must-b hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
