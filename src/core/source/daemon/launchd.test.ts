...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.must-b.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MUSTB_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.must-b.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MUSTB_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.must-b.gateway.plist",
    },
    {
      name: "uses profile-specific label when MUSTB_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MUSTB_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.must-b.jbphoenix.plist",
    },
    {
      name: "prefers MUSTB_LAUNCHD_LABEL over MUSTB_PROFILE",
      env: {
        HOME: "/Users/test",
        MUSTB_PROFILE: "jbphoenix",
        MUSTB_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MUSTB_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MUSTB_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MUSTB_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MUSTB_PROFILE: "myprofile",
        MUSTB_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.must-b.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
