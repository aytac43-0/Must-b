...
describe("agent components", () => {
  const createCfg = (): Must-bConfig => ({}) as Must-bConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/must-b-sessions-test.json");
  });
