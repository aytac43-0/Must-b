/**
 * Hook system for Must-b agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __must-b_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__must-b_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
