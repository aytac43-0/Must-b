...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "must-b-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["MUSTB_BUNDLED_HOOKS_DIR"]);
    process.env.MUSTB_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: Must-bConfig) => {
