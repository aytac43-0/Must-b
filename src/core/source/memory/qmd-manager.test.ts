...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: Must-bConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: Must-bConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__must-bMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__must-bMcporterColdStartWarned;
  });
