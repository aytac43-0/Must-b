...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.MUSTB_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.MUSTB_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.MUSTB_SERVICE_MARKER = originalServiceMarker;
    }
  });
