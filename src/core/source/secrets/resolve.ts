...
function resolveResolutionLimits(config: MustBonfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: MustBonfig): SecretProviderConfig {
