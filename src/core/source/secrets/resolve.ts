...
function resolveResolutionLimits(config: Must-bConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: Must-bConfig): SecretProviderConfig {
