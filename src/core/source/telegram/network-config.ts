...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "MUSTB_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "MUSTB_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "MUSTB_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable MUSTB_TELEGRAM_DNS_RESULT_ORDER
