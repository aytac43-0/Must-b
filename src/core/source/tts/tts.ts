...
export function resolveTtsConfig(cfg: MustBonfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: MustBonfig): string | undefined {
  ...
  for (const provider of providers) {
    ...
    try {
      if (provider === "edge") {
        ...
        const tempRoot = resolvePreferredMustBmpDir();
