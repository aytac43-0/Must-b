...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("must-b");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "must-b");
