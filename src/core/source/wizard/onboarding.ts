...
export async function runOnboardingWizard(
  ...
  let baseConfig: MustBonfig = snapshot.valid ? (snapshot.exists ? snapshot.config : {}) : {};
  ...
  let nextConfig: MustBonfig = applyOnboardingLocalWorkspaceConfig(baseConfig, workspaceDir);
