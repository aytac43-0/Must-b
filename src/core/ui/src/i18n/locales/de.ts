...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.must-b/must-b.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von must-b dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
