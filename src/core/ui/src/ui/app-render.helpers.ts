...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as Must-bApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as Must-bApp).resetToolStream();
  (state as unknown as Must-bApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as Must-bApp;
