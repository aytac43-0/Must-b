...
const UPDATE_BANNER_DISMISS_KEY = "must-b:control-ui:update-banner-dismissed:v1";
      ...
      <div class="sidebar-header">
        ${
          ...
          <div class="sidebar-brand">
            <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="Must-b" />
            <span class="sidebar-brand__title">Must-b</span>
          </div>
        `
        }
        <button
