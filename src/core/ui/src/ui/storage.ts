const KEY = "must-b.control.settings.v1";
const LEGACY_TOKEN_SESSION_KEY = "must-b.control.token.v1";
const TOKEN_SESSION_KEY_PREFIX = "must-b.control.token.v1:";
...
function deriveDefaultGatewayUrl(): { pageUrl: string; effectiveUrl: string } {
  ...
  const configured =
    ...
    typeof window.__MUSTB_CONTROL_UI_BASE_PATH__ === "string" &&
    window.__MUSTB_CONTROL_UI_BASE_PATH__.trim();
